...
<?php require "views/templates/header.php"; ?>
        ...
        <section class="hero__container container">
            <h1 class="hero__title"><?php echo $this->nombre;?></h1>
            <p class="hero__paragraph">En esta sección encontraras todos los productos relacionados con <?php echo $this->nombre;?></p>
            <a href="#" class="cta">El Estilo En Tú Tiempo</a>
        </section>
    </header>
    <style>
    .hero::before {
        background-image: linear-gradient(180deg, #0000008c 0%, #0000008c 100%), url('<?php echo constant("URL") . "public/imagenes/fondo5.jpeg"?>');
    }
    </style>
    <main>
        <section class="price container">
            ...
            <div class="tab-content active" id="home">
                ...
                <div class="price__table ">
                    <?php
                    foreach ($this->listaMujeresCate as $listaM) {
                    ?>
            ...
            <div class="tab-content" id="profile">
                ...
                <div class="price__table ">
                    <?php
                    foreach ($this->listaHombresCate as $listaH) {
                    ?>
                        <div class="price__element">
                            <div class="price__img-container">
